...
public class Exemplo01{
    ...
    String nome = "Emilly Dantas";
    int idade= 16;
    boolean chuva = true;// Em váriaveis booleanas eu uso true ou false
    char letra = 'E';// Todo char DEVE estar com aspas simples ''
    double salario = 3550.49;
    float altura= (float) 1.59;// Estou convertendo um double para float
